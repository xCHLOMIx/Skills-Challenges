...
const Navbar = ({ toggleSideBar }) => {
    return (
        <div className="bg-white w-full p-3 flex justify-between gap-2 max-sm:pr-3 pr-7">
            ...
            <div className="bg-offwhite max-w-96 max-sm:mx-3 w-full flex items-center pl-2 overflow-hidden rounded-lg">
                <GoSearch size={"20px"} />
                <input className="bg-transparent py-2 pl-2 w-full outline-none" type="text" placeholder="Search here..." />
            </div>
            <div>
                <div className="flex gap-3">
                    <div className=" bg-gray-200 h-10 w-10 rounded-full p-[10px]">
                        <FaRegBell size={"100%"} />
                    </div>
